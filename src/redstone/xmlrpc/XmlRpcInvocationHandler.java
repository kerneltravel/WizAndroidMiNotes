...
/**
 * When receiving XML-RPC messages, XmlRpcServers parse the XML payload and
 * dispatch control to XmlRpcInvocationHandlers that perform the actual
 * processing.
 * 
 * <p>
 * The XML-RPC library includes a reflective handler that other handlers may
 * extend or use to wrap them up. @see serializers.ReflectiveInvocationHandler
 * </p>
 * 
...
public interface XmlRpcInvocationHandler {
	/**
	 * Called by a dipatcher when an XML-RPC invocation has been received (and
	 * processed by any XmlRpcInvocationProcessors).
	 * 
	 * @param method
