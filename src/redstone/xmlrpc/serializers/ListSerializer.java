...
/**
 * A custom serializer that support serialization of objects implementing the
 * java.util.List interface. For ArrayLists, for instance, this may be more
 * effective than the CollectionSerializer since this serializer uses random
 * access rather that instantiating an iterator.
 * 
