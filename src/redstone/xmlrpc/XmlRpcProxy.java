...
public class XmlRpcProxy implements InvocationHandler {
	...
	public static Object createProxy(URL url, Class[] interfaces,
	...
	@SuppressWarnings("rawtypes")
	public static Object createProxy(URL url, String objectName,
			Class[] interfaces, boolean streamMessages) {
		return Proxy.newProxyInstance(interfaces[0].getClassLoader(),
				interfaces, new XmlRpcProxy(url, objectName, streamMessages));
	}
	...
	public Object invoke(Object proxy, Method method, Object[] args)
		...
		if (objectName == null) {
			...
			if (declaringClass.indexOf('$') != -1) {
				handlerName = declaringClass.substring(declaringClass
						.lastIndexOf('$') + 1);
