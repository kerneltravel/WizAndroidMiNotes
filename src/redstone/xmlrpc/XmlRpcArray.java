...
public class XmlRpcArray extends ArrayList {
	 ...
	 *             if the value at the given index is not a String.
	 */
	 ...
	 *             if index > size() - 1.
	 * @throws ClassCastException
	 *             if the value at the given index is not a Boolean.
	 */
	 ...
	 *             if index > size() - 1.
	 * @throws ClassCastException
	 *             if the value at the given index is not an Integer.
	 */
	 ...
	 *             if index > size() - 1.
	 * @throws ClassCastException
	 *             if the value at the given index is not a Integer.
	 */
	 ...
	 *             if index > size() - 1.
	 * @throws ClassCastException
	 *             if the value at the given index is not a Double.
	 */
	 ...
	 *             if index > size() - 1.
	 * @throws ClassCastException
	 *             if the value at the given index is not an Array.
	 */
	 ...
	 *             if index > size() - 1.
	 * @throws ClassCastException
	 *             if the value at the given index is not a Struct.
	 */
	 ...
	 *             if index > size() - 1.
	 * @throws ClassCastException
	 *             if the value at the given index is not a Date.
	 */
