...
public class ExtraFieldUtils {
		...
		LOOP: while (start <= data.length - WORD) {
			...
			if (start + WORD + length > data.length) {
				...
				case UnparseableExtraField.READ_KEY:
					...
					if (local) {
						field.parseFromLocalFileData(data, start, data.length
								- start);
					} else {
	...
	public static byte[] mergeLocalFileDataData(ZipExtraField[] data) {
		...
		int regularExtraFieldCount = lastIsUnparseableHolder ? data.length - 1
				: data.length;
	...
	public static final class UnparseableExtraField {
		 ...
		 */
		public static final UnparseableExtraField THROW = new UnparseableExtraField(
				THROW_KEY);
		 ...
		 */
		public static final UnparseableExtraField SKIP = new UnparseableExtraField(
				SKIP_KEY);
		 ...
		 */
		public static final UnparseableExtraField READ = new UnparseableExtraField(
				READ_KEY);
