...
import cn.code.notes.tool.ResourceParser.NoteItemBgResources;
...
public class NotesListItem extends LinearLayout {
	...
	public NotesListItem(Context context) {
		...
		mAlert = (ImageView) findViewById(R.id.iv_alert_icon);// 提醒
		mTitle = (TextView) findViewById(R.id.tv_title);// 标题
		mTime = (TextView) findViewById(R.id.tv_time);// 时间
		mCallName = (TextView) findViewById(R.id.tv_name);// CallName
	...
	public void bind(Context context, NoteItemData data, boolean choiceMode,
		...
		mItemData = data;
		if (data.getId() == Notes.ID_CALL_RECORD_FOLDER) {// 通话便签folder
		...
		} else if (data.getParentId() == Notes.ID_CALL_RECORD_FOLDER) {// 通话便签
			mCallName.setVisibility(View.VISIBLE);
			mCallName.setText(data.getCallName());
			mTitle.setTextAppearance(context,
					R.style.TextAppearanceSecondaryItem);
		...
		mTime.setText(DateUtils.getRelativeTimeSpanString(data
				.getModifiedDate()));
