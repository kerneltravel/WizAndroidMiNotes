...
public class DataUtils {
	...
	public static boolean visibleInNoteDatabase(ContentResolver resolver,
		...
		Cursor cursor = resolver.query(
				...
				null, NoteColumns.TYPE + "=? AND " + NoteColumns.PARENT_ID
	...
	public static boolean existInNoteDatabase(ContentResolver resolver,
			long noteId) {
		Cursor cursor = resolver.query(
				ContentUris.withAppendedId(Notes.CONTENT_NOTE_URI, noteId),
				null, null, null, null);
	...
	public static boolean existInDataDatabase(ContentResolver resolver,
			long dataId) {
		Cursor cursor = resolver.query(
	...
	public static HashSet<AppWidgetAttribute> getFolderNoteWidget(
			ContentResolver resolver, long folderId) {
		Cursor c = resolver.query(Notes.CONTENT_NOTE_URI, new String[] {
	...
	public static String getCallNumberByNoteId(ContentResolver resolver,
		...
		Cursor cursor = resolver.query(Notes.CONTENT_DATA_URI,
				new String[] { CallNote.PHONE_NUMBER }, CallNote.NOTE_ID
						+ "=? AND " + CallNote.MIME_TYPE + "=?", new String[] {
	...
	public static long getNoteIdByPhoneNumberAndCallDate(
			ContentResolver resolver, String phoneNumber, long callDate) {
		Cursor cursor = resolver.query(Notes.CONTENT_DATA_URI,
				new String[] { CallNote.NOTE_ID }, CallNote.CALL_DATE
						+ "=? AND " + CallNote.MIME_TYPE
						+ "=? AND PHONE_NUMBERS_EQUAL(" + CallNote.PHONE_NUMBER
						+ ",?)", new String[] { String.valueOf(callDate),
						CallNote.CONTENT_ITEM_TYPE, phoneNumber }, null);
	...
	public static String getSnippetById(ContentResolver resolver, long noteId) {
		...
		throw new IllegalArgumentException("Note is not found with id: "
				+ noteId);
	}
